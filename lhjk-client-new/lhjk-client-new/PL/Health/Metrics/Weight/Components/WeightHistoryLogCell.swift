...
final class WeightHistoryLogCell: UITableViewCell {

    static let reuseID = "WeightHistoryLogCell"
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        [timeLabel, valueLabel, statusBadge, sourceLabel].forEach(card.addSubview)
    ...
    func configure(item: WeightLogItem) {
        timeLabel.text = item.timeDisplay
        valueLabel.text = item.weightDisplay
