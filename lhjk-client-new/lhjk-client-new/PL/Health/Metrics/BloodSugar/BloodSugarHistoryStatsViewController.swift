...
final class BloodSugarHistoryStatsViewController: BaseViewController {

    private let viewModel = BloodSugarHistoryStatsViewModel()
    ...
    override func setupUI() {
        ...
        rateLabel.textColor = UIColor(hexString: "#FF406F")
        headCard.addSubview(rateLabel)

        progressView.backgroundColor = .fdBg2
        progressView.layer.cornerRadius = 4
        progressFill.backgroundColor = UIColor(hexString: "#FF406F")
...
extension BloodSugarHistoryStatsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0: cell.configure(title: "近7天", stats: viewModel.statistics?.seven)
        default: cell.configure(title: "近30天", stats: viewModel.statistics?.thirty)
        }
        return cell
    }
}
