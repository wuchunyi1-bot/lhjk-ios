...
final class BloodSugarHistoryLogViewController: BaseViewController {

    private let viewModel = BloodSugarHistoryLogViewModel()
    ...
    override func setupUI() {
        ...
        tableView.register(BloodSugarHistoryLogCell.self, forCellReuseIdentifier: BloodSugarHistoryLogCell.reuseID)
...
extension BloodSugarHistoryLogViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int { viewModel.items.count }

    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: BloodSugarHistoryLogCell.reuseID, for: indexPath) as! BloodSugarHistoryLogCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let sugarId = item.sugarId?.value { params["sugarId"] = sugarId }
