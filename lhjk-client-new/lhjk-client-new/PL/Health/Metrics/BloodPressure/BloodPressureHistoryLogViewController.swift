...
/// 日志 Tab
final class BloodPressureHistoryLogViewController: BaseViewController {

    private let viewModel = BloodPressureHistoryLogViewModel()
    ...
    override func setupUI() {
        ...
        tableView.register(BloodPressureHistoryLogCell.self, forCellReuseIdentifier: BloodPressureHistoryLogCell.reuseID)
...
extension BloodPressureHistoryLogViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int { viewModel.items.count }

    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: BloodPressureHistoryLogCell.reuseID, for: indexPath) as! BloodPressureHistoryLogCell
