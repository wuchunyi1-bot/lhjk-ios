...
@MainActor
final class BloodPressureHistoryLogViewModel: ObservableObject {

    @Published private(set) var items: [BloodPressureLogItem] = []
    ...
    private func load(append: Bool) {
        ...
        Task {
            do {
                ...
                hasMore = list.count >= BloodPressureConstants.defaultPageSize
