...
@MainActor
final class BloodPressureDetailViewModel: ObservableObject {
    ...
    init(monitorId: String?, service: BloodPressureService = AppContainer.shared.bloodPressureService) {
    ...
    func delete() {
        ...
        Task {
            do {
                ...
                NotificationCenter.default.post(name: .bloodPressureRecordDidDelete, object: nil)
